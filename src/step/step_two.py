...
def begin_task(begin_id, classifier_form, content_frequency, catalog_index_form, catalog_frequency):
    classifier_form = 'D:/data-mining/data' + classifier_form
    content_frequency = 'D:/data-mining/data' + content_frequency
    catalog_index_form = 'D:/data-mining/data' + catalog_index_form
    catalog_frequency = 'D:/data-mining/data' + catalog_frequency
    count = 0
